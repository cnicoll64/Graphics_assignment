...
protected:
	...
	sf::Texture* One_T, * Two_T, * Three_T, * Three_Line_T, * Four_Line, * Four_Square_T, * Four_L_T, * Four_T_T, * Four_Z_T;
	...
	sf::Sprite* One, * Two, * Three, * Three_Line, * Four_Square, * Four_L, * Four_T, * Four_Z;
